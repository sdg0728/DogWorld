...
public class AjaxUserIdListCommand implements Command {
	...
	private void responseJSON2(HttpServletRequest request, HttpServletResponse response) {
		UserDTO [] dtoArr = (UserDTO []) request.getAttribute("list");
		
		AjaxIdSearchListJSON list = new AjaxIdSearchListJSON();  // response 할 Java 객체
