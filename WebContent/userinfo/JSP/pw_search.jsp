...
<head>
	...
	<link rel="stylesheet" href="../CSS/pw_search.css?ver=<%= System.currentTimeMillis()%>" />
	<title>비밀번호 찾기</title>
</head>
<body>
	...
	<section id="sign_secA">
		<div class="container">
			...
			<form method="post" action="pw_searchOk.do" name="pwSearch" onsubmit="return check()">
	            ...
	            <div class="row">
	            	<div>
						<ul class="actions fit small">
							...
							<li><a href="sign_search.do" class="button alt fit">비밀번호 찾기</a></li>
						</ul>
					</div>
	            </div>
...
<script src="../JS/pw_search.js?ver=<%= System.currentTimeMillis()%>" type="text/javascript"></script>
